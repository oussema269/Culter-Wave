...
public class CardView1 extends Pane {
    ...
    public CardView1(Formation formation) {
...
titleLabel.setStyle("-fx-background-color: #c86c34;");
      ...
      //  borderPane.setPadding(new Insets(USE_PREF_SIZE, USE_PREF_SIZE, USE_PREF_SIZE, USE_PREF_SIZE));
      //     borderPane.setBorder(new Insets(10, 10, 0, 10));
        borderPane.setTop(titleLabel);
        borderPane.setCenter(descriptionLabel);
        borderPane.setBottom(new Pane(dateLabel, paysLabel));
        //typeLabel
