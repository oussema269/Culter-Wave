...
Participationformation p=new Participationformation();
    ...
    private void onChooseFileButtonClicked(ActionEvent event) {
        ...
        if (selectedDirectory != null) {
           ...
           try {
         writeExcel(directoryPath,sp.afficherbyidformation(Integer.parseInt(idformation.getText())));
} catch (Exception e) {
    System.out.println("Error sending email: " + e.getMessage());
...
Participationformation p=new Participationformation();
    ...
    @FXML
    private void retourToDaschboardformaterur(MouseEvent event) {
        
        
        
        try {
                            Parent root;
                            FXMLLoader loader = new FXMLLoader(getClass().getResource("FormationDachboardFormateuer.fxml"));
                            root = loader.load();
    ...
    @FXML
    private void retouer(ActionEvent event) {
         try {
                            Parent root;
                            FXMLLoader loader = new FXMLLoader(getClass().getResource("FormationDachboardFormateuer.fxml"));
                            root = loader.load();
                            
                             btnaceppter.getScene().setRoot(root);
                        } catch (IOException ex) {
                            Logger.getLogger(FormationDachboardFormateuerController.class.getName()).log(Level.SEVERE, null, ex);
                        }
    }
