...
public class TestcardviewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        filterbyDate.setOnAction(e -> {
            ...
            ObservableList<Formation> filteredPeople = FXCollections.observableArrayList(sf.afficherAccept());
           ...
           dejapart.setOnAction((event) -> {
                       
                     

                        try {
                            Parent root;
                            FXMLLoader loader = new FXMLLoader(getClass().getResource("DejaapartinthisFormation.fxml"));
                            root = loader.load();
                         
                            dejapart.getScene().setRoot(root);
