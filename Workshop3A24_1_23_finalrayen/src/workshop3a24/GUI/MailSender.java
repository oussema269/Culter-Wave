...
public class MailSender {
     public static void sendMail( Personne  client ) throws Exception {
        String mailContent = "<!DOCTYPE html>\n"
                ...
                + "																							TO\n"
                + "																							CulterWave</span></span></strong></span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                ...
                + "																							style=\"color:#2190e3;font-size:34px;\">"+client.getNom()+" </span></span></strong></span>\n"
                + "																		</p>\n"
                + "																	</div>\n"
                + "																</div>\n"
                + "															</td>\n"
                ...
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                + "																				style=\"font-size:18px;color:#000000;\"><br>Details:<br> Company name : "+"CulterWave"+"</span>\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			<span\n"
                ...
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			CulterWave © -  Your favorite company tool.\n"
                + "																		</p>\n"
                + "																		<p\n"
                + "																			style=\"margin: 0; font-size: 14px; text-align: center;\">\n"
                + "																			Tunis, Tunisia.</p>\n"
                ...
                + "																					:\n"
                + "																					CulterWave@gmail.com</strong></span>\n"
                + "																		</p>\n"
                + "																	</div>\n"
                + "																</div>\n"
                + "															</td>\n"
        ...
        Message message = prepareMessage(session, myAccountEmail, client.getEmail(), mailContent);
    ...
    private static Message prepareMessage(Session session, String myAccountEmail, String recipient , String mailContent) {
        try {
            ...
            message.setSubject("Welcome to CulterWave");
