...
public class FormationApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        TestcardviewController controller = loader.getController();
        List<Formation> formations = sf.afficher();; // Your method to retrieve the list of Formation objects
        controller.setFormations(formations);
